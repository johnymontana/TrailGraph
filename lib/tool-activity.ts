...
const TOOL_LABELS: Record<string, string> = {
  ...
  find_trails: 'Finding trails',
  trail_detail: 'Trail detail',
  add_trail_to_trip: 'Adding a hike to your trip',
  set_trail_preferences: 'Saving your trail preferences',
  save_trail: 'Saving a trail',
  record_trail_done: 'Logging a hike',
  build_loop: 'Building trail loops',
  trail_vibe: 'Vibe-matching trails',
  surprise_trail: 'Finding a surprise trail',
  trails_like_mine: 'Trails hikers like you did',
