...
import { Stack, Text, HStack, IconButton, Badge, Icon } from '@chakra-ui/react';
import { Reorder, useDragControls } from 'motion/react';
import { LuX, LuGripVertical, LuFootprints, LuTentTree } from 'react-icons/lu';
...
export function StopList() {
  const { trip, dayMap, removeStop, removeHike, removeLodging, persistReorder, beginDrag, endDrag } = useTripBuilder();
